    ...
    <body class="font-sans antialiased text-gray-900 flex h-screen bg-gray-100 overflow-hidden">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50">
                ...
                {{ $slot }}
                <!-- Footer dengan WhatsApp & Instagram -->
<footer class="bg-white border-t border-gray-200 pt-16 pb-8 mt-auto">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-12 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-xl font-bold text-[#0f2942] tracking-wide">IT Helpdesk</span>
                </div>
            ...
            <div class="space-y-5">
                <h3 class="text-sm font-bold text-gray-900 tracking-wider uppercase">Menu Utama</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">Dashboard</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">Buat Laporan Baru</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">Riwayat Tiket</a></li>
                </ul>
            </div>

            <div class="space-y-5">
                <h3 class="text-sm font-bold text-gray-900 tracking-wider uppercase">Pusat Bantuan</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">Buku Panduan (PDF)</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">SOP Pemeliharaan</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#0f2942] font-medium transition-colors duration-200">Katalog Kerusakan</a></li>
                </ul>
            </div>

            <div class="space-y-5">
                <h3 class="text-sm font-bold text-gray-900 tracking-wider uppercase">Kontak Darurat</h3>
                <ul class="space-y-3 text-sm">
                    <li class="flex items-center gap-2 text-gray-500 font-medium">
        ...
        <div class="mt-16 flex flex-col md:flex-row items-center justify-between border-t border-gray-200 pt-8 gap-4">

            <span class="text-sm text-gray-500 font-medium order-last md:order-first text-center md:text-left">
                &copy; {{ date('Y') }} IT Department. Dirancang oleh <span class="text-[#0f2942] font-bold">Arif & Dika</span>. All rights reserved.
            </span>

            <div class="flex gap-5 text-gray-400 order-first md:order-last">
                <a href="#" class="hover:text-[#0f2942] transition-colors duration-200" title="Kirim Email ke IT">
                ...
                <a href="#" class="hover:text-[#0f2942] transition-colors duration-200" title="Pusat Pesan">
            ...
            <!-- Bagian Kanan: Sosial Media (WA & IG) -->
            <div class="flex justify-center space-x-6 md:order-2">

                <!-- Tombol WhatsApp -->
                <!-- Ganti angka 628... dengan nomor WA tujuan -->
                ...
                <!-- Tombol Instagram -->
                <!-- Ganti akunhotel dengan username IG yang dituju -->
